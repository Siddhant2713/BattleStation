...
export const Motherboard = () => {
    return (
        <group position={[-1, 2.25, 0]} rotation={[0, 0, 0]}>
            {/* PCB */}
...
export const GPU = ({ onFocus }: { onFocus?: (position: THREE.Vector3) => void }) => {
...
export const RAMSticks = () => {
    return (
        <group position={[-0.9, 3.05, 0.8]}>
